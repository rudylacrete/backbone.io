(function() {
    ...
    var Mixins = {
        ...
        bindBackend: function() {
            ...
            this.backend.ready(function() {
                ...
                self.bind(event + ':read', function(models) {
        ...
        changeChannel:function(name,callback){
            this.backend.changeChannel.apply(this.backend,arguments);
        }
    };
    ...
    function buildBackend(collection) {
        ...
        var backend = {
            ...
            changeChannel:function(channel,callback){
                var _this = this;
                //be sure we are not currently setting a channel
                ready.then(function(){
                    ready = new Promise();
                    _this.channel = channel;
                    configureSocket(_this.socket);
                    ready.then(callback);
                });
            }
        };
